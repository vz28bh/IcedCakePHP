        ...
        <ul class="nav">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li class="dropdown-submenu">
                ...
                <ul class="dropdown-menu">
                  <li><a class="" href="<?php echo Router::url(array('action' => 'date_demo')); ?>"><?php echo __('Date'); ?></a></li>
                  <li><a class="" href="<?php echo Router::url(array('action' => 'autocomplete_demo')); ?>"><?php echo __('Autocomplete'); ?></a></li>
                </ul>
              </li>
            </ul>
          </li>
          <?php foreach ($allModels as $model): ?>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><?php echo $this->Html->link(__('List'), array('controller' => Inflector::pluralize($model), 'action' => 'index')); ?></li>
                <li><?php echo $this->JqueryDialog->link(__('Add'), array('controller' => Inflector::pluralize($model), 'action' => 'add'),array('data-callback'=>'reload_window')); ?></li>
              </ul>
            </li>
          <?php endforeach; ?>
        </ul>
