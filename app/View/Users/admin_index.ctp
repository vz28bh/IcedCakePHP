    ...
    foreach ($users as $user):
      ...
      <tr<?php echo $class; ?>>
        ...
        <td class="actions">
          ...
          <?php echo $this->Html->link(__d('users', 'Delete'), array('action' => 'delete', $user[$model]['id']), array('class' => 'btn btn-mini'), sprintf(__d('users', 'Are you sure you want to delete # %s?'), $user[$model]['id'])); ?>
        </td>
      </tr>
    <?php endforeach; ?>
  </table>
